...
This is an example of a build that demonstrates using Ivy configurations to group dependencies.
...
In this example, imagine that utils provides utilities related to both Scalate and Saxon.
